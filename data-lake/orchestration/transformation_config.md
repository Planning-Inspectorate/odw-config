...
Entity objects have the below structure
- `entity_name` - The name of the entity. The entity will hold a number of stage objects

Stage objects have the below structure
